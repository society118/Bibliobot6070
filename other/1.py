...
def main():
    ...
    while True:
        ...
        if choice == "1":
            get_ip_info(input("Enter IP: "))
        elif choice == "2":
            get_phone_info(input("Enter phone number: "))
        elif choice == "3":
            scan_ports(input("Enter IP: "))
        elif choice == "4":
            google_dorking()
        elif choice == "5":
            breached_data_check()
        elif choice == "6":
            find_admin_panel(input("Enter domain: "))
        elif choice == "7":
            whois_lookup(input("Enter domain: "))
        elif choice == "8":
            subdomain_finder(input("Enter domain: "))
        elif choice == "9":
            reverse_ip_lookup(input("Enter IP: "))
        elif choice == "10":
            extract_links(input("Enter website URL: "))
        elif choice == "11":
            extract_metadata(input("Enter file path: "))
        elif choice == "12":
            username_checker(input("Enter username: "))
        elif choice == "13":
            dns_lookup(input("Enter domain: "))
        elif choice == "14":
            email_header_analyzer()
        elif choice == "15":
            print(f"{yellow}Website Crawler is not implemented yet!{reset}")
        elif choice == "16":
            email_header_analyzer()
        elif choice == "17":
            social_media_lookup(input("Enter username: "))
        elif choice == "18":
            print(f"{yellow}Website Screenshot is not implemented yet!{reset}")
        elif choice == "19":
            print(f"{yellow}Hash Identifier is not implemented yet!{reset}")
        elif choice == "20":
            print(f"{yellow}IP Geolocation is not implemented yet!{reset}")
        elif choice == "21":
            print(f"{yellow}MAC Address Lookup is not implemented yet!{reset}")
        elif choice == "22":
            dns_history_check(input("Enter domain: "))
        elif choice == "23":
            file_metadata_extractor(input("Enter file path: "))
        elif choice == "24":
            print(f"{yellow}Pastebin Dump Search is not implemented yet!{reset}")
        elif choice == "25":
            dark_web_search(input("Enter search query: "))
        elif choice == "26":
            username_availability(input("Enter username: "))
        elif choice == "27":
            website_tech_stack(input("Enter website URL: "))
        elif choice == "28":
            ssl_certificate_info(input("Enter domain: "))
        elif choice == "29":
            ip_blacklist_check(input("Enter IP: "))
        elif choice == "30":
            print("Exiting...")
            break
        else:
